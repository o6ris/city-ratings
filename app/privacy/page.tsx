...
export const metadata: Metadata = {
  ...
  description:
    "Understand how Neighbours Voices collects, stores, and protects your data. Your privacy matters to us.",
};
...
export default function PrivacyPolicyPage() {
  return (
    <main className="mt-12 lg:mt-0">
      ...
      <p className="mt-4">
        At neighboursvoices.ca, your privacy is important to us. This Privacy
      ...
      <p>
        These services may collect anonymized usage data according to their own
        privacy policies.
      </p>
      ...
      <p>
        ...
        practices. Your data is stored securely and access is limited to
      ...
      <p>
        We may update this Privacy Policy. Continued use of the Website means
